...
<body>
	<div class="welcome">
		...
		<h1>You have arrived - hi!</h1>
		<center>
		<img src="http://www.adamtglass.com/wp-content/uploads/2011/05/230977_10150202293787801_580537800_7021375_4336907_n.jpg"/>
		</center>
		<strong>The data you passed to ze view is: <?php echo $thing; ?></strong>
		<br>			
		<strong><em>Also, <?php echo $otherThing; ?></em></strong>
	</div>
</body>
</html>
